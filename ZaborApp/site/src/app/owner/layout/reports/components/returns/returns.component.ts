...
const gridColumnList: DatatablesNetConfigColumns[] = [
  ...
  {data: "order_number"},
  {data: "reason"},
  {data: "refund_amount", render: simpleCurrencyLabel},
  {data: "refund_method"},
  {data: "remaining_cash_in_drawer",  render: simpleCurrencyLabel},
  {data: "remaining_cash_in_order",  render: simpleCurrencyLabel},
  {data: "rest_name"},
  {data: "cashier_name"},
  {data: "shift_open"},
  {data: "shift_close"},
...
export class ReturnsComponent implements OnInit {
  ...
  tableTitle = `Report (Returns / Refunds)`;
  orderedBy: any;
  currentShift: any;
  ...
  rerender(): void {
    ...
    if (!this.lastWeek && !this.last30days) {
      this.tableTitle = `Report (Returns / Refunds)`;
    }
  ...
  ngOnInit() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        that.httpClient
          .post<DataTablesResponse>(`${environment.apiUrl}/user/getRefundDetails`, dataTablesParameters, this.httpOptionsService.makeHttpRequestOptionsWithAuthentication())
          .subscribe(resp => {
              ...
              this.total_refund_amount = simpleCurrencyLabel(resp.totalRefund, "other");
