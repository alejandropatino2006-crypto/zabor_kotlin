...
@Component({
  selector: 'app-sales-by-kiosk',
  templateUrl: './sales-by-kiosk.component.html',
  styleUrls: ['./sales-by-kiosk.component.scss']
})
export class SalesByKioskComponent implements OnInit {
  ...
  tableTitle = `Report (Kiosk / Cashier)`;
  orderedBy: any;
  currentShift: any;
  ...
  rerender(): void {
    ...
    if (!this.lastWeek && !this.last30days) {
      this.tableTitle = `Report (${this.orderedBy})`;
    }
  }
