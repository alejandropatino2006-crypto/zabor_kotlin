...
@Component({
  selector: 'app-sales-by-bartag',
  templateUrl: './sales-by-bartag.component.html',
  styleUrls: ['./sales-by-bartag.component.scss']
})
export class SalesByBartagComponent implements OnInit {
  ...
  @Input() orderBy = "-1";
  @Input() shiftId = -1;
  tableTitle = `Report By Bar Menu Item`;
  currentShift: any;
  orderedBy: any;
  ...
  rerender(): void {
    ...
    if (!this.lastWeek && !this.last30days && this.resId !== -1 && this.selectedDate == null) {
      this.tableTitle = `Report (Bar Menu Item)`;
    }
  }
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        that.httpClient
          ...
          .subscribe(resp => {
              ...
              this.totalRefundAmount = simpleCurrencyLabel(resp.totalSales, "other");
