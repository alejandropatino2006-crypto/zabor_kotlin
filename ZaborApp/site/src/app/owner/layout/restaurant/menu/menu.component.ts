...
// export const dataURLtoFileCustom = (dataurl: string, filename: string) => {
...
@Component({
  ...
  styleUrls: ["../restaurant.component.scss", "../menu-retail/menu-retail.component.scss"],
})
...
export class MenuComponent implements OnInit {
  ...
  private static getDefaultValueIfNullOrUndefinedExcplicitly(val, defaultVal) {
    if (MenuComponent.isNullOrUndefinedExcplicitly(val)) {
      return defaultVal;
    }
    return val;
  }
  ...
  UploadExcel(e) {
    ...
    if (e.target.files[0].length < 1) { return false; }
      ...
      .subscribe(
        (data) => {
          ...
          this.openTimeForm.patchValue({
            monopen_time: MenuComponent.getDefaultValueIfNullOrUndefinedExcplicitly(data.group.monopen_time, MenuComponent.defaultStartTime),
            monclose_time: MenuComponent.getDefaultValueIfNullOrUndefinedExcplicitly(data.group.monclose_time, MenuComponent.defaultEndTime),
            tueopen_time: MenuComponent.getDefaultValueIfNullOrUndefinedExcplicitly(data.group.tueopen_time, MenuComponent.defaultStartTime),
            tueclose_time: MenuComponent.getDefaultValueIfNullOrUndefinedExcplicitly(data.group.tueclose_time, MenuComponent.defaultEndTime),
            wedopen_time: MenuComponent.getDefaultValueIfNullOrUndefinedExcplicitly(data.group.wedopen_time, MenuComponent.defaultStartTime),
            wedclose_time: MenuComponent.getDefaultValueIfNullOrUndefinedExcplicitly(data.group.wedclose_time, MenuComponent.defaultEndTime),
            thuopen_time: MenuComponent.getDefaultValueIfNullOrUndefinedExcplicitly(data.group.thuopen_time, MenuComponent.defaultStartTime),
            thuclose_time: MenuComponent.getDefaultValueIfNullOrUndefinedExcplicitly(data.group.thuclose_time, MenuComponent.defaultEndTime),
            friopen_time: MenuComponent.getDefaultValueIfNullOrUndefinedExcplicitly(data.group.friopen_time, MenuComponent.defaultStartTime),
            friclose_time: MenuComponent.getDefaultValueIfNullOrUndefinedExcplicitly(data.group.friclose_time, MenuComponent.defaultEndTime),
            satopen_time: MenuComponent.getDefaultValueIfNullOrUndefinedExcplicitly(data.group.satopen_time, MenuComponent.defaultStartTime),
            satclose_time: MenuComponent.getDefaultValueIfNullOrUndefinedExcplicitly(data.group.satclose_time, MenuComponent.defaultEndTime),
            sunopen_time: MenuComponent.getDefaultValueIfNullOrUndefinedExcplicitly(data.group.sunopen_time, MenuComponent.defaultStartTime),
            sunclose_time: MenuComponent.getDefaultValueIfNullOrUndefinedExcplicitly(data.group.sunclose_time, MenuComponent.defaultEndTime),
          });
          ...
          data.menuitems.forEach((element, index) => {
              ...
              } else { this.selectedItemCus.length = 0; }
            });
          } else {
            Swal.fire(
              Swaldata.SwalErrorToast(
  ...
  getCusName(id) {
    ...
    this.groupCustomizationOption.forEach((ele) => {
      if (ele.id === id) { name = ele.itemName; }
    });
    return name;
  }
  ...
  onSubmitCustomization() {
    if (!this.customizationGroup.valid) { return; }
      ...
      if (result.value) {
        await this.readExcel(e).then((r) => {
          ...
          this.restaurantService.uploadinvQua({
            ...
            .subscribe(
              (data) => {
                if (data.status) { Swal.fire(Swaldata.SwalSuccessToast(data.msg)); } else { Swal.fire(Swaldata.SwalErrorToast(data.msg)); }
              },
              (err) => {
                Swal.fire(Swaldata.SwalErrorToast(err));
              }
