...
const gridColumnList: DatatablesNetConfigColumns[] = [
  ...
  {data: "menugroup_id"},
  {data: "menugroup_name"},
  {data: "total_sales_by_menugroup", render: simpleCurrencyLabel}
];


@Component({
  selector: 'app-sales-for-menu-group',
  templateUrl: './sales-for-menu-group.component.html',
  styleUrls: ['./sales-for-menu-group.component.scss']
})
export class SalesForMenuGroupComponent implements OnInit {
  ...
  tableTitle = `Report By Menu Group`;
  orderedBy: any;
  ...
  ngOnInit() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        that.httpClient
          .post<DataTablesResponse>(`${environment.apiUrl}/user/getSalesReportByMenuGroup`, dataTablesParameters, this.httpOptionsService.makeHttpRequestOptionsWithAuthentication())
          .subscribe(resp => {
